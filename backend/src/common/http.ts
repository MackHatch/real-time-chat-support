...
export function unauthorized(
  ...
  throw new HttpException(buildBody(code, message, details), HttpStatus.UNAUTHORIZED);
}
...
export function forbidden(
  ...
  throw new HttpException(buildBody(code, message, details), HttpStatus.FORBIDDEN);
}
